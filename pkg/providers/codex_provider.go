...
func (p *CodexProvider) ChatWithStream(ctx context.Context, messages []Message, tools []ToolDefinition, model string, opts ChatOptions) (*LLMResponse, error) {
	// 使用基础实现，模拟流式行为
...
func createCodexTokenSource() func() (string, string, error) {
	return func() (string, string, error) {
		...
		if cred == nil {
			return "", "", fmt.Errorf("no credentials for openai. Run: mortisagent auth login --provider openai")
		}
