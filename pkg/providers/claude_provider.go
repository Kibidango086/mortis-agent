...
func (p *ClaudeProvider) ChatWithStream(ctx context.Context, messages []Message, tools []ToolDefinition, model string, opts ChatOptions) (*LLMResponse, error) {
	// 使用基础实现，模拟流式行为
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: mortisagent auth login --provider anthropic")
		}
